  ...
  <div class="signup-container">
    <el-form class="signup-form" label-position="left">
      ...
      <el-form-item>
        ...
        <el-input ref="username" v-model="username" placeholder="账号(字符限制在3-20位哦)" name="username" type="text" tabindex="1"
          maxlength="14" minlength="1" clearable />
      </el-form-item>
      ...
      <el-tooltip>
        <el-form-item>
          ...
          <el-input v-model="password" type="password" placeholder="请输入6-16位密码(要由数字，字母和符号组成)" name="password" tabindex="3"
